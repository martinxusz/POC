...
Ext.extend(ListTree, Ext.tree.TreePanel, {
			...
			initComponent : function() {
				this.bbar = [tx.actions.newList, tx.actions.deleteList, '-',
						tx.actions.newFolder, tx.actions.deleteFolder];
							...
							.confirm('Confirm',
									...
									function(btn) {
										if (btn == 'yes') {
											...
											tx.data.lists.remove(this.store
													.getById(s.id));
