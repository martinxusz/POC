 ...
 * @version $Id: DateTimeField.js,v 1.1 2010/05/28 03:25:51 wyy Exp $
 * 
 * @class Ext.ux.form.DateTime
 * @extends Ext.form.Field
 * 
 * @history 2008-1-31 Jack Slocum Updated for reformatting and code edits
 */
Ext.ux.form.DateTime = Ext.extend(Ext.form.Field, {
			...
			onMouseDown : function(e) {
				// just to prevent blur event when clicked in the middle of
				// fields
...
// fire events later
			...
			updateHidden : function() {
				if (this.isRendered) {
					var value = Ext.isDate(this.dateValue) ? this.dateValue
