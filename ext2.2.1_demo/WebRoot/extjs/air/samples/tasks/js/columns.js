...
// Grid column plugin that does the complete/active button in the left-most
// column
...
ReminderColumn = function() {
	...
	function onMenuCheck(item) {
		if (item.reminder === false) {
			...
			var s = record.data.dueDate
					? record.data.dueDate.clearTime(true)
					: new Date().clearTime();
