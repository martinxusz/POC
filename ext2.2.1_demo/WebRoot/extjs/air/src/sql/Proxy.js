 ...
 *          that reads from a SQLLite database.
 * 
 * @constructor
 * @param {Object}
 *            conn an {@link Ext.sql.Connection} object
 * @param {String}
 *            table The name of the database table
 * @param {String}
 *            keyName The primary key of the table
 * @param {Ext.data.Store}
 *            store The datastore to bind to
 * @param {Boolean}
 *            readonly By default all changes to the store will be persisted to
 *            the database. Set this to true to override to make the store
 *            readonly.
 */
