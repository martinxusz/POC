 ...
 * @singleton Allows you to manipulate the native system clipboard and handle
 *            various formats. This class is essentially a passthrough to
 *            air.Clipboard.generalClipboard at this time, but may get more
 *            Ext-like functions in the future.
 * 
 * The Clipboard has different types which it can hold: CONSTANT - value
 * air.ClipboardFormats.TEXT_FORMAT - air:text air.ClipboardFormats.HTML_FORMAT -
 * air:html air.ClipboardFormats.RICH_TEXT_FORMAT - air:rtf
...
Ext.air.Clipboard = function() {
	...
	return {
		 ...
		 * 
		 * @param {String}
		 *            format Use the air.ClipboardFormats CONSTANT or the string
		 *            value
		 */
		 ...
		 *            value
		 * @param {Function}
		 *            fn The function to evaluate when getting the clipboard
		 *            data
		 */
