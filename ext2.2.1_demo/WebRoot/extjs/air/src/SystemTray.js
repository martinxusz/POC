...
Ext.air.SystemTray = function() {
	...
	return {
		/**
		 * Sets the Icon and tooltip for the currently running application in
		 * the SystemTray or Dock depending on the operating system.
		 * 
		 * @param {String}
		 *            icon Icon to load with a URLRequest
		 * @param {String}
		 *            tooltip Tooltip to use when mousing over the icon
		 * @param {Boolean}
		 *            initWithIcon Boolean to initialize with icon immediately
		 */
		 ...
		 * whether the event which has just occurred is informational (single
		 * bounce) or critcal (continual bounce).
		 * 
		 * @param priority
		 *            {air.NotificationType} The priorities are
		 *            air.NotificationType.INFORMATIONAL and
		 *            air.NotificationType.CRITICAL.
		 */
		 ...
		 * 
		 * @param {Array}
		 *            actions Configurations for Ext.air.MenuItem's
		 */
