...
Ext.air.MusicPlayer = Ext.extend(Ext.util.Observable, {
			...
			pausePosition : 0,
			/**
			 * @cfg {Number} progressInterval How often to fire the progress
			 *      event when playing music in milliseconds Defaults to 500.
			 */
			 ...
			 * 
			 * @param {Object}
			 *            percent Ranges from 0 to 1 specifying volume of sound.
			 */
			...
			/**
			 * Play a sound, if no url is specified will attempt to resume the
			 * activeSound
			 * 
			 * @param {String}
			 *            url (optional) Url resource to play
			 */
			play : function(url) {
				if (url) {
					this.stop();
