...
Ext.extend(Ext.air.NativeWindow, Ext.air.NativeObservable, {
	 ...
	 * 
	 * @param {Boolean}
	 *            nonInteractive (optional) Boolean flag to allow the full
	 *            screen window to be interactive or not. By default this is
	 *            false. Example Code: var win = new
	 *            Ext.air.NativeWindow({instance:
	 *            Ext.air.NativeWindow.getRootWindow()}); win.fullscreen();
	 */
