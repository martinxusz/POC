Ext.QuickTip = Ext.extend(Ext.ToolTip, {
			...
			onTargetOver : function(h) {
				...
				var f, g = Ext.fly(c), b = this.tagConfig;
				var d = b.namespace;
				if (this.interceptTitles && c.title) {
					...
					f = c.qtip || g.getAttributeNS(d, b.attribute)
				}
				if (f) {
					var a = g.getAttributeNS(d, b.hide);
					this.activeTarget = {
						el : c,
						text : f,
						width : g.getAttributeNS(d, b.width),
						autoHide : a != "user" && a !== "false",
						title : g.getAttributeNS(d, b.title),
						cls : g.getAttributeNS(d, b.cls),
						align : g.getAttributeNS(d, b.align)
					};
					this.delayShow()
				}
			},
