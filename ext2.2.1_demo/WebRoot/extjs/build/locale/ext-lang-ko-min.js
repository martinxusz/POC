...
Date.monthNames = ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월",
		"11월", "12월"];
Date.dayNames = ["�?�", "월", "화", "수", "목", "금", "토"];
if (Ext.MessageBox) {
...
if (Ext.form.VTypes) {
	Ext.apply(Ext.form.VTypes, {
				emailText : '�?�메�?� 주소 형�?�? 맞게 입력해야합니다. (예: "user@domain.com")',
				urlText : 'URL 형�?�? 맞게 입력해야합니다. (예: "http://www.domain.com")',
...
if (Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion) {
	Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
				...
				collapsibleSplitTip : "�?�기변경�?� 위해 드래그, 숨기기 위해 �?�블�?�� 하세요."
			})
};