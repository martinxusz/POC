...
Date.monthNames = ["Януари", "Февруари", "Март", "�?прил", "Май", "Юни", "Юли",
		"�?вгу�?т", "Септември", "Октомври", "�?оември", "Декември"];
Date.monthNumbers = {
	Jan : 0,
	Feb : 1,
	Mar : 2,
...
Date.dayNames = ["�?едел�?", "Понеделник", "Вторник", "Ср�?да", "Четвъртък",
		"Петък", "Събота"];
if (Ext.MessageBox) {
...
if (Ext.form.VTypes) {
	Ext.apply(Ext.form.VTypes, {
		emailText : 'Това поле тр�?бва да бъде емейл във формат "user@domain.com"',
		urlText : 'Това поле тр�?бва да бъде URL във формат "http://www.domain.com"',
