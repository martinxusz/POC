	...
	initComponent : function(){
		...
		switch(this.quarterDefaultValue){
			...
			case 3 : 
				...
				break;
			case 4 : 
			//alert(this.quarterDefaultValue+'---3--3---');
				k.push([-1, '请选择月份']);
				k.push([10, '10月']);
				k.push([11, '11月']);
				k.push([12, '12月']);
		...
		this.items = [this.ReportLabel,this.yearLabel,this.Year,this.quarterLabel,this.Quarter,this.monthLabel,this.Month];
