 ...
 *          {@link Ext.data.Store Store} object using this Reader will
 *          reconfigure itself to use the newly provided field definition and
 *          fire its {@link Ext.data.Store#metachange metachange} event. In
 *          undergoing this change, the Store sets its
 *          {@link Ext.data.Store#sortInfo sortInfo} property from the
 *          <tt>sortInfo</tt> property in the new metadata. Note that
 *          reconfiguring a Store potentially invalidates objects which may
 *          refer to Fields or Records which no longer exist.
 *          </p>
 * 
 * <p>
 * The <b><tt>metaData</tt></b> property may contain any of the
 * configuration options for this class. Additionally, it may contain a <b><tt>fields</tt></b>
 * property which the JsonReader will use as an argument to
 * {@link Ext.data.Record#create} to configure the layout of the Records which
 * it will produce.
 * <p>
 ...
 * Store-driven control initialize itself. The metachange event handler may
 * interrogate the <b><tt>metaData</tt></b> property (which may contain any
 * user-defined properties needed) and the <b><tt>metaData.fields</tt></b>
