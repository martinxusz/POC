...
(function() {
	...
	Ext.dd.DragDrop.prototype = {
		...
		/**
		 * When set to true, other DD objects in cooperating DDGroups do not
		 * receive notification events when this DD object is dragged over them.
		 * Defaults to false.
		 * 
		 * @property moveOnly
		 * @type boolean
		...
		/**
		 * By default, all instances can be a drop target. This can be disabled
