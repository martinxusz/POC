/**
 * Lithuanian Translations (UTF-8) By Vladas Saulis, October 18, 2007
 */
...
Date.monthNames = ["Saulis", "Vasaris", "Kovas", "Balandis", "Gegužė",
		"Birželis", "Liepa", "Rugpjūtis", "Rugsėjis", "Spalis", "Lapkritis",
		"Gruodis"];

Date.getShortMonthName = function(month) {
	return ["Sau", "Vas", "Kov", "Bal", "Geg", "Bir", "Lie", "Rgp", "Rgs",
			"Spa", "Lap", "Grd"];
};
...
Date.dayNames = ["Pirmadienis", "Antradienis", "Trečiadienis",
