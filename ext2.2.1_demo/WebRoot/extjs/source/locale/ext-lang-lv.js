...
Date.monthNames = ["Janvāris", "Februāris", "Marts", "Aprīlis", "Maijs",
		"Jūnijs", "Jūlijs", "Augusts", "Septembris", "Oktobris", "Novembris",
		"Decembris"];

Date.dayNames = ["Svētdiena", "Pirmdiena", "Otrdiena", "Trešdiena",
...
if (Ext.form.VTypes) {
	Ext.apply(Ext.form.VTypes, {
		...
		urlText : 'Šajā laukā jāieraksta URL formātā "http:/'
				+ '/www.domēns.lv"',
