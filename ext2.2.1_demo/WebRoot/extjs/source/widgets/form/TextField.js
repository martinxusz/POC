...
Ext.form.TextField = Ext.extend(Ext.form.Field, {
	 ...
	 *      unwanted content from the value before validation (defaults to
	 *      null).
	 */
	/**
	 ...
	 *      during field validation (defaults to null). If specified, this
	 *      function will be called only after the built-in validations ({@link #allowBlank},
	 *      {@link #minLength}, {@link #maxLength}) and any configured
	 *      {@link #vtype} all return true. This function will be passed the
	 *      current field value and expected to return boolean true if the value
	 *      is valid or a string error message if invalid.
	 */
	validator : null,
	/**
	 ...
	 *      (defaults to null). Note that this value will be submitted to the
	 *      server if this field is enabled and configured with a {@link #name}.
	 */
	emptyText : null,
	/**
