 ...
 *          <p>
 *          A combobox control with support for autocomplete, remote-loading,
 ...
 *          {@link #valueField}, you must specify a {@link #hiddenName} to
 *          create a hidden input field to hold the value of the valueField. The
 *          <i>{@link #displayField}</i> is shown in the text field which is
 *          named according to the {@link #name}.
...
Ext.form.ComboBox = Ext.extend(Ext.form.TriggerField, {
	 ...
	 *      clicked. Use 'all' to run the query specified by the allQuery config
	...
	/**
	 * The value of the match string used to filter the store. Delete this
	 * property to force a requery.
	 * 
	 * @property lastQuery
	 * @type String
	 */
