 ...
 *          </p>
 *          <p>
 *          By default, FormPanel uses an {@link Ext.layout.FormLayout} layout
 *          manager, which styles and renders fields and labels correctly. When
 *          nesting additional Containers within a FormPanel, you should ensure
 *          that any descendant Containers which host input Fields use the
 ...
 *          Ext Form contained in this FormPanel, use the
 *          {@link Ext.form.BasicForm#standardSubmit standardSubmit) option:</p><pre><code>
 *          var myForm = new Ext.form.FormPanel({ standardSubmit: true, items:
 *          myFieldset });</code></pre>
 * 
 * @constructor
 * @param {Object}
...
Ext.FormPanel = Ext.extend(Ext.Panel, {
			 ...
			 *      {@link Ext.Button} configs used to add buttons to the footer
			 *      of this FormPanel.<br>
			 *      <p>
			 *      Buttons in the footer of a FormPanel may be configured with
			 *      the option <tt>formBind: true</tt>. This causes the
			 *      form's {@link #monitorValid valid state monitor task} to
			 *      enable/disable those Buttons depending on the form's
			 *      valid/invalid state.
			 *      </p>
			 */
			/**
			 ...
			 *      state <b>client-side</b> and regularly fires the
			 *      {@link #clientvalidation} event passing that state.<br>
			 *      <p>
			 *      When monitoring valid state, the FormPanel enables/disables
			 *      any of its configured {@link #button}s which have been
			 *      configured with <tt>formBind: true<tt> depending
