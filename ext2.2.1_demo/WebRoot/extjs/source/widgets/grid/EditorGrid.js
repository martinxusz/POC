 ...
 *          columns.
 *          </p>
 *          The editable columns are specified by providing an
 ...
 *          {Ext.form.Field#ComboBox ComboBox} which uses the same
 *          {@link Ext.form.Field#valueField value}-to-{@link Ext.form.Field#displayFieldField description}
 *          mapping would be an appropriate editor.
 *          </p>
 *          If there is a more complex mismatch between the visible data in the
 *          grid, and the editable data in the {@link Edt.data.Store Store},
 *          then code to transform the data both before and after editing can be
 *          injected using the {@link #beforeedit} and {@link #afteredit}
 *          events.
 * @constructor
 * @param {Object}
...
Ext.grid.EditorGridPanel = Ext.extend(Ext.grid.GridPanel, {
	...
	initComponent : function() {
		...
		if (!this.selModel) {
			 ...
			 *      Note that the SelectionModel must be compatible with the
			 *      model of selecting cells individually, and should support a
			 *      method named <tt>getSelectedCell</tt> (for these reasons,
		...
		this.addEvents(
				...
				"beforeedit",
				/**
				 * @event afteredit Fires after a cell is edited. The edit event
