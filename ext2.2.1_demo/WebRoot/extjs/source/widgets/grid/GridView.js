...
Ext.extend(Ext.grid.GridView, Ext.util.Observable, {
	 ...
	 *       with {@link Ext.grid.GridPanel#enableDragDrop enableDragDrop}
	 *       <tt>true</tt>.</b>
	 *       </p>
	 *       <p>
	 ...
	 *      columns to fit the grid width and prevent horizontal scrolling. This
	 *      option overrides any (@link Ext.grid.ColumnModel#width width}
	 *      settings in the ColumnModel.
	 */
	forceFit : false,
	/**
	...
	initElements : function() {
		...
		/**
		 * The GridView's body Element which encapsulates all rows in the Grid.
		 * {@link Ext.Element Element}. Read-only.
		 * <p>
	...
	/**
	 * Return the HtmlElement representing the grid row which contains the
	 * passed element.
	 * 
	 * @param {Element}
	 *            el The target element
	 * @return The row element, or null if the target element is not within a
	 *         row of this GridView.
	 */
	findRow : function(el) {
		if (!el) {
			return false;
	 ...
	 * @param {Element}
	 *            el The target element
	 * @return The row index, or <b>false</b> if the target element is not
