...
Ext.grid.PropertyGrid = Ext.extend(Ext.grid.EditorGridPanel, {
			/**
			 * @cfg {Object} propertyNames An object containing property
			 *      name/display name pairs. If specified, the display name will
			 *      be shown in the name column instead of the property name.
			 */
			/**
